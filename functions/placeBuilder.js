...
exports.rawWaterSource = function(currentTime){

    rawWaterSource = {};
    rawWaterSource.datasetId = "waterDataset001";
    rawWaterSource.entities = [];
    rawWaterSourceTemp = {};
    rawWaterSourceTemp = JSON.parse(fs.readFileSync('./Places/rawWaterSource.json', 'utf-8'));

    rawWaterSourceTemp.id = conf.place.id;
    rawWaterSourceTemp.name.value = conf.place.name;

    rawWaterSourceTemp.location.value.coordinates = conf.place.coordinates;
